  ...
  <bkt-index-skeleton body-class="bkt-bg-white">
    ...
    <template v-slot:body>
      ...
      <bkt-create-entity-from-index
          ...
          genericFetchEntity.data && genericFetchEntity.data['campaigns'] && genericFetchEntity.data['campaigns'].length === 0 && genericFetchEntity.search && !genericFetchEntity.search.title && !genericFetchEntity.tags && !genericFetchEntity.status"
          type="interview"
          :href="$routes.generate('campaign_draft_edit')"
      >
        campaign
