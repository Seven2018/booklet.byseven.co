...
Company.create(name: 'SIDE', address: '40 Rue de la Folie-Regnault', zipcode: '75011', city: 'Paris', logo: 'https://d2hqc0017d4cuc.cloudfront.net/assets/logo.svg')
...
User.create(firstname: 'Marie', lastname: 'Decamps', company_id: 2, email: 'marie.decamps@side.co', password: 'tititoto', access_level: 'Admin', gender: 'F', picture: 'https://media-exp1.licdn.com/dms/image/C5603AQFD2rfkeOFN4w/profile-displayphoto-shrink_200_200/0?e=1585785600&v=beta&t=tqxqxQ7HsjpsQBhxWf98ZwSDTSD1fPvicOhEczEuQAY')
