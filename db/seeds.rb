...
User.create(firstname: "Brice", lastname: "Chapuis", company: seven, email: "brice.chapuis@byseven.co", password: ENV['SEED_SEVEN_PASSWORD'], access_level: "Super Admin", gender: 'M', picture: 'https://media-exp1.licdn.com/dms/image/C4D03AQH76liGuqaaMA/profile-displayphoto-shrink_200_200/0?e=1583971200&v=beta&t=sXSYg68rJ2YBIzs5NrgrgJZf_CkmdMkiuIEuZ2nRU0A')
User.create(firstname: "Hedi", lastname: "Mestiri", company: seven, email: "hedi.mestiri@byseven.co", password: ENV['SEED_SEVEN_PASSWORD'], access_level: "HR", gender: 'M', picture: '')
User.create(firstname: "Yahya", lastname: "Fallah", company: seven, email: "yahya.fallah@byseven.co", password: ENV['SEED_SEVEN_PASSWORD'], access_level: "HR", gender: 'M', picture: 'https://media-exp1.licdn.com/dms/image/C5603AQFc5Cf9X4gL_w/profile-displayphoto-shrink_200_200/0?e=1585180800&v=beta&t=eJBIoMSgMxXKenQr7PrWixQSFBpIvcjhme-cQ5hjOm4')
User.create(firstname: "Jorick", lastname: "Roustan", company: seven, email: "jorick.roustan@byseven.co", password: ENV['SEED_SEVEN_PASSWORD'], access_level: "Manager", gender: 'M', picture: 'http://static8.viadeo-static.com/_Z-gjrDmn0yPKoiw9P481xLMzs0=/300x300/member/00223346scu6m79w%3Fts%3D1449006810000')
User.create(firstname: "Mathilde", lastname: "Meurer", company: seven, email: "mathilde.meurer@byseven.co", password: ENV['SEED_SEVEN_PASSWORD'], access_level: "HR", gender: 'F', picture: 'https://www.tedxbordeaux.com/wp-content/uploads/2018/07/equipe_mathilde_meurer.jpg')
User.create(firstname: "Marjorie", lastname: "Buisson", company: bigmamma, email: "marjoriebuisson@gmail.com", password: ENV['SEED_BIGM_PASSWORD'], access_level: "HR", gender: 'F', picture: 'https://pbs.twimg.com/profile_images/801444623302455297/lJ4dYiKX.jpg')
